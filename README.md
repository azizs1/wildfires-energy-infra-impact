# Modeling the Spread of Wildfires and Assessing Urban Energy Infrastructure Vulnerability
**Authors:** Aziz Shaik and Nicholas Cheung
**Course:** CS 5834: Intro to Urban Computing (Fall 2025)

This project explores the use of urban computing techniques to model the spread of wildfires and evaluate the risk to critical energy infrastructure.
...
3. Run `uv run python ./src/main.py` to run code and write images.
>NOTE: Run `uv run python ./src/main.py --no-cache` to start fresh and not rely on cache. This may take longer on successive runs.
...
- We use the following HIFLD datasets published on Kaggle by Behrooz Sohrabi for energy infrastructure data:
  ...
  - [US Electric Power Transmission Lines](https://www.kaggle.com/datasets/behroozsohrabi/us-electric-power-transmission-lines)
